...
const env = {
  ...
  TWILIO_STATUS_CALLBACK_URL: opt("TWILIO_STATUS_CALLBACK_URL", ""),
  TWILIO_OUTBOUND_VOICE_URL: opt("TWILIO_OUTBOUND_VOICE_URL", ""),
  ...
  OUTBOUND_ENABLED: optBool("OUTBOUND_ENABLED", false),
  OUTBOUND_AUTO_START: optBool("OUTBOUND_AUTO_START", false),
  OUTBOUND_ALLOWED_DAYS: opt("OUTBOUND_ALLOWED_DAYS", "Sun,Mon,Tue,Wed,Thu"),
  OUTBOUND_ALLOWED_HOURS: opt("OUTBOUND_ALLOWED_HOURS", "09:00-18:00"),
  OUTBOUND_TIMEZONE: opt("OUTBOUND_TIMEZONE", opt("TIME_ZONE", "Asia/Jerusalem")),
  OUTBOUND_MAX_CALLS_PER_HOUR: optInt("OUTBOUND_MAX_CALLS_PER_HOUR", 30),
  OUTBOUND_MIN_GAP_SECONDS: optInt("OUTBOUND_MIN_GAP_SECONDS", 60),
  OUTBOUND_MAX_ACTIVE_CALLS: optInt("OUTBOUND_MAX_ACTIVE_CALLS", 1),
  OUTBOUND_BATCH_SIZE: optInt("OUTBOUND_BATCH_SIZE", 1),
  OUTBOUND_RETRY_NO_ANSWER_MIN: optInt("OUTBOUND_RETRY_NO_ANSWER_MIN", 180),
  OUTBOUND_RETRY_BUSY_MIN: optInt("OUTBOUND_RETRY_BUSY_MIN", 60),
  OUTBOUND_RETRY_CALLBACK_MIN: optInt("OUTBOUND_RETRY_CALLBACK_MIN", 1440),
  OUTBOUND_ADMIN_TOKEN: opt("OUTBOUND_ADMIN_TOKEN", opt("TWILIO_AUTH_TOKEN", "")),
};
