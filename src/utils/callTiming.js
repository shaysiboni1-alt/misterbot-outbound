...
function consumeSummary(callSid, streamSid) {
  ...
  return {
    ...
    metrics: {
      ...
      opening_sent_to_first_gemini_audio_ms: diff(row, "opening_sent", "first_gemini_audio_chunk"),
      opening_sent_to_first_twilio_media_ms: diff(row, "opening_sent", "first_twilio_media_sent"),
      gemini_audio_to_first_twilio_media_ms: diff(row, "first_gemini_audio_chunk", "first_twilio_media_sent"),
      ws_start_to_first_twilio_media_ms: diff(row, "twilio_stream_start", "first_twilio_media_sent"),
